def get_star_icons():
    solid_star = '<i class="fa-solid fa-star solid_star"></i>'
    empty_star = '<i class="fa-solid fa-star empty_star"></i>'
    return {
        'solid': solid_star,
        'empty': empty_star,
...
ICON_LIKE = {
    'True': '<i class="fa-solid fa-heart solid_heart"></i>',
    'False': '<i class="fa-solid fa-heart empty_heart"></i>',
    'Filter': '<i class="fa-regular fa-heart"></i>',
    'White': '<i class="fa-solid fa-heart text-white"></i>',
}

ICON_SOLVE = {
    'True': '<i class="fa-solid fa-circle-check answer_correct"></i>',
    'False': '<i class="fa-solid fa-circle-xmark answer_wrong"></i>',
